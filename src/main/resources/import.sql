INSERT INTO user (id, user_id, password, name, create_date, saved_file_name, extention) values (1, 'brad903', 'password', 'Brad', CURRENT_TIMESTAMP(), 'avatar', 'png');
INSERT INTO user (id, user_id, password, name, create_date, saved_file_name, extention) values (2, 'leejh903', 'password', '이정현', CURRENT_TIMESTAMP(), 'avatar', 'png');
