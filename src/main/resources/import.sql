...
INSERT INTO issue (id, comment, reg_date, subject, writer_id) VALUES (1, '질문~', sysdate, '제목~', 'abcshc');
INSERT INTO issue (id, comment, reg_date, subject, writer_id) VALUES (2, 'comment', sysdate, 'subject', 'hong');
