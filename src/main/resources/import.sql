...
INSERT INTO issue (id, subject, comment, writer_id, milestone_id) values (1, '테스트용 이슈 첫번째', '뭔 내용용용용용 아무 내용이나 적자', 1, 1);
INSERT INTO issue (id, subject, comment, writer_id, milestone_id) values (2, '테스트용 이슈 두번째', '아무 내용이나 적자', 2, 3);
INSERT INTO issue (id, subject, comment, writer_id, milestone_id) values (3, '테스트용 이슈 세번째', '무슨 내용을 적을까', 1, 1);
