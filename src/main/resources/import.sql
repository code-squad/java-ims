...
insert into answer (id, writer_id, issue_id , contents, deleted) values (1, 1, 1, 'answer in db', false );
insert into answer (id, writer_id, issue_id , contents, deleted) values (2, 3, 1, 'answer writed by jimmy', false );
insert into answer (id, writer_id, issue_id , contents, deleted) values (3, 3, 3, 'answer writed by jimmy2', false );