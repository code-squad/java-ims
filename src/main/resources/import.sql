...
INSERT INTO label (id, deleted, level, writer_id) values (1, false, 'label1 - BackLog', 1);
INSERT INTO label (id, deleted, level, writer_id) values (2, false, 'label2 - Planning', 2);
INSERT INTO label (id, deleted, level, writer_id) values (3, false, 'label3 - Ready', 2);
INSERT INTO label (id, deleted, level, writer_id) values (4, false, 'label4 - Working', 1);
INSERT INTO label (id, deleted, level, writer_id) values (5, false, 'label5 - InReview', 1);
