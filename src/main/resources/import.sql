...
INSERT INTO milestone (id, create_date, modified_date, end_date, start_date, subject) values (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '취업');
INSERT INTO milestone (id, create_date, modified_date, end_date, start_date, subject) values (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '결혼');
