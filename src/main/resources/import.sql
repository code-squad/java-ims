...
INSERT INTO issue (id, subject, comment) values (1, 'db에 있는 subject', 'db에 있는 comment');
INSERT INTO issue (id, subject, comment) values (2, 'db에 있는 test subject', 'db에 있는 test comment2');