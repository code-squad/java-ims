...
INSERT INTO issue (id, subject, comment, writer_id) values (1, '안녕하세요1', '하이하이하이하이하이', 1);
INSERT INTO issue (id, subject, comment, writer_id) values (2, '안녕하세요2', '너의 머리속은 마구니가 꼈어!', 1);