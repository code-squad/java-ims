...
INSERT INTO issue (id, subject, comment, writer_id, deleted, has_milestone) values (1, 'test subject-1', 'test comment', 1, 0, 0);
INSERT INTO issue (id, subject, comment, writer_id, deleted, has_milestone) values (2, 'test subject-2', 'test comment', 1, 0, 0);
INSERT INTO issue (id, subject, comment, writer_id, deleted, has_milestone) values (3, 'test subject-3', 'test comment', 1, 0, 0);
INSERT INTO issue (id, subject, comment, writer_id, deleted, has_milestone) values (4, 'test subject-4', 'test comment', 3, 0, 0);
