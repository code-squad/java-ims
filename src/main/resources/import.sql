...
INSERT INTO label (id, name) values (1, '스포츠');
INSERT INTO label (id, name) values (2, '정치');
INSERT INTO label (id, name) values (3, '연예');
INSERT INTO label (id, name) values (4, '라벨4');
INSERT INTO label (id, name) values (5, '라벨5');
INSERT INTO label (id, name) values (6, '라벨6');
