...
INSERT INTO issue (id, writer_id, subject, comment) values (1, 1, 'db에 있는 subject', 'db에 있는 comment');
INSERT INTO issue (id, writer_id, subject, comment) values (2, 2, 'db에 있는 test subject', 'db에 있는 test comment2');
INSERT INTO issue (id, writer_id, subject, comment) values (3, 3, 'db에 있는 subject', 'db에 있는 test comment3');
