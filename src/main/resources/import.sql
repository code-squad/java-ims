...
INSERT INTO label (id, create_date, modified_date, subject, comment) values (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '라벨1', '치명적인 버그발생');
INSERT INTO label (id, create_date, modified_date, subject, comment) values (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '라벨2', '치명적인 버그발생');
INSERT INTO label (id, create_date, modified_date, subject, comment) values (3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '라벨3', '치명적인 버그발생');
INSERT INTO label (id, create_date, modified_date, subject, comment) values (4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '라벨4', '치명적인 버그발생');
INSERT INTO label (id, create_date, modified_date, subject, comment) values (5, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '라벨5', '치명적인 버그발생');