...
public class MultipartFileService {
    ...
    public Multipart add(User user, long issueId, MultipartFile file) throws IOException {
        ...
        Multipart multipart = new Multipart(user, issue, file.getOriginalFilename(), uploadPath);
...
//    public List<Multipart> findByIssueId(long issueId) {
//        return multipartRepository.(issueId);
//    }
